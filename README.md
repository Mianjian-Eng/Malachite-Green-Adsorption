# Malachite Green Adsorption Analysis
...
## Key Features
1. **Kinetics:** Modeling PFO and PSO equations.
2. **Isotherms:** Non-linear regression for Langmuir and Freundlich models.
3. **Thermodynamics:** Van't Hoff plot analysis to determine $\Delta H^\circ$ and $\Delta S^\circ$.
